...
//#include "CondFormats/DataRecord/interface/EcalTPGSpikeRcd.h"                                                                                                                        //#include "CondFormats/DataRecord/interface/EcalTPGTowerStatusRcd.h"
...
// class declaration
//
/** \class EcalEBTrigPrimPhase2ESProducer                                                                                                                                              \author L. Lutton, N. Marinelli - Univ. of Notre Dame                                                                                                                                   Description: forPhase II                                                                                                                                                              */
...
public:
  ...
  //std::unique_ptr<EcalTPGLutGroup> produceLutGroup(const EcalTPGLutGroupRcd &);                                                                                               std::uniq//std::unique_ptr<EcalTPGStripStatus> produceBadStrip(const EcalTPGStripStatusRcd &);                                                                                                  //std::unique_ptr<EcalTPGTowerStatus> produceBadTT(const EcalTPGTowerStatusRcd &);                                                                                                     //std::unique_ptr<EcalTPGSpike> produceSpike(const EcalTPGSpikeRcd &);
